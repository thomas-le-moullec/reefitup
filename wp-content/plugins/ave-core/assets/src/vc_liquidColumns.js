// // right from js_composer/js/frontend_editor/containers/vc_column.js
// (function ( $ ) {
...
// 		render: function () {
// 			var width;
// 			var $customAnimations = this.$el.find('.wpb_wrapper[data-custom-animations]');
...
// 				// this.vc_iframe.parallax = this.vc_iframe.parallax || [];
...
// 				// this.vc_iframe.parallax[this.vc_iframe.parallax.length] = $parallax.liquidParallax();
// 			} );
