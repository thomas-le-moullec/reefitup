...
if( class_exists( 'ReduxFramework' ) ) {
	...
	class Liquid_Custom_Fonts {
		 ...
		 * @var array
		 */
		private $liquid_custom_fonts_svg = null;
		...
		function add_font_face_css( $css ) {
			...
			$svg_arr   = $this->liquid_custom_fonts_svg;
		...
		function get_custom_fonts() {
			...
			$this->liquid_custom_fonts_svg = ! empty( $liquid_options['custom_font_svg'] ) ? $liquid_options['custom_font_svg'] : null;			
