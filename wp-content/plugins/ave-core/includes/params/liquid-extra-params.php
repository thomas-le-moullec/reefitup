...
function liquid_row_extras() {
	...
	$custom_animation_params = array(
		array(
			...
			'description'      => esc_html__( 'Will enable animation for columns, it will be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'ave-core' ),
			'weight' => 1,
		),
...
function liquid_columns_extras() {
	...
	$custom_animation_params = array(
		array(
			...
			'description'      => esc_html__( 'Will enable animation for content of columns, it will be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'ave-core' ),
		),
