...
$before = $after = '';
	...
	elseif( 'candy' === $style ) {
		echo '<div class="liquid-blog-grid liquid-blog-style-candy row" data-liquid-masonry="true">';
	...
	while( have_posts() ): the_post();
		...
		elseif( 'candy' === $style ) {
			$post_classes[] = 'liquid-lp liquid-lp liquid-blog-item liquid-blog-item-candy liquid-blog-scheme-dark';
			$i++;
			if( $i % 2 == 0 ) {
