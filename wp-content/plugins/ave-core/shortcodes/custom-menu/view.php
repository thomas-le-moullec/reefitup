...
?>
<?php if( $sticky ) { ?><div id="<?php echo $this->get_id() ?>" class="lqd-custom-menu lqd-sticky-menu <?php echo $menu_alignment; ?> <?php echo $this->get_id(); ?>" data-pin="true" data-pin-options='{ "offset": "[data-sticky-header] .mainbar-wrap.is-stuck, #wpadminbar", "duration": "last-link" }' data-move-element='{ "target": ".vc_row" }'><?php } ?>
