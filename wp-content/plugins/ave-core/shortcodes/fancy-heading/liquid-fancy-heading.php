...
class LD_Fancy_Heading extends LD_Shortcode { 
	...
	public function get_params() {
		...
		$this->params = array(
			...
			array(
				...
				'description' => esc_html__( 'Set a number from 0 to 1', 'ave-core' ),
			...
			array(
				...
				'heading'     => esc_html__( 'Enable Split?', 'ave-core' ),
	...
	protected function generate_css() {
		...
		if ( !empty( $gradient ) ) {
			$elements[ liquid_implode( '%1$s .ld-fh-txt'  ) ]['background'] = $gradient;
		}
