...
echo '<div class="carousel-container carousel-nav-circle carousel-nav-bordered carousel-nav-sm ' . $this->get_id() . '" data-filterable-carousel="true">';
	...
	echo '<div class="carousel-items row" data-lqd-flickity=\'{ "autoplay": false, "equalHeightCells": true, "filters": "#' . $filter_id . '", "prevNextButtons": true, "navArrow": 6, "fullwidthSide": true, "buttonsAppendTo": "#' . $filter_id . '" }\' ' . $this->get_options() . '>';
