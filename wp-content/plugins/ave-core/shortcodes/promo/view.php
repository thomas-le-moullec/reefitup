...
<div id="<?php echo $this->get_id() ?>" class="<?php echo ld_helper()->sanitize_html_classes( $classes ) ?>">
	<div class="lqd-promo-inner">
		...
		<div class="lqd-promo-img">
			<div class="lqd-promo-img-inner" data-reveal="true" data-reveal-options='{ "direction": "rl", "bgcolor": "<?php echo esc_attr( $overlay_color ); ?>", "revealSettings": { "onCoverAnimations": { "scale": [2, 1] } } }'>
				<?php $this->get_image(); ?>
