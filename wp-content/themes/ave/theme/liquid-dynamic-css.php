...
function liquid_dynamic_css_array() {
	...
	if( !empty( $header_sticky_bg ) ) {
		$css['@media ( min-width: 1200px )'][ liquid_implode( array( '.main-header .is-stuck' ) ) ]['background'] = $header_sticky_bg . ' !important';
	}
	if( !empty( $header_sticky_color ) ) {
		$css['@media ( min-width: 1200px )'][ liquid_implode( array( '.mainbar-wrap.is-stuck .social-icon a, .mainbar-wrap.is-stuck .header-module .ld-module-trigger, .mainbar-wrap.is-stuck .main-nav > li > a, .mainbar-wrap.is-stuck .ld-module-search-visible-form .ld-search-form input' ) ) ]['color'] = $header_sticky_color . ' !important';
		$css['@media ( min-width: 1200px )'][ liquid_implode( array( '.mainbar-wrap.is-stuck .ld-module-search-visible-form .ld-search-form input' ) ) ]['border-color'] = $header_sticky_color . ' !important';
	}
	if( !empty( $header_sticky_hover_color ) ) {
		$css['@media ( min-width: 1200px )'][ liquid_implode( array( '.mainbar-wrap.is-stuck .social-icon a:hover, .mainbar-wrap.is-stuck .main-nav > li > a:hover' ) ) ]['color'] = $header_sticky_hover_color . ' !important';
	}
	if( !empty( $header_fullscreen_nav_bg ) ) {
		$css['@media ( min-width: 1200px )'][ liquid_implode( array( '.header-fullscreen .navbar-fullscreen' ) ) ]['background'] = $header_fullscreen_nav_bg . '!important';
	}
	...
	if( !empty( $header_custom_bg ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '.main-header .navbar-header' ) ]['background'] = $header_custom_bg;
	}
	elseif( !empty( $header_custom_bg_global ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '.main-header .navbar-header' ) ]['background'] = $header_custom_bg_global;
	}

	if( !empty( $header_custom_color ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '.main-header .ld-module-trigger, .main-header .ld-search-form .input-icon' ) ]['color'] = $header_custom_color;
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '.main-header .nav-trigger .bar' ) ]['background-color'] = $header_custom_color;
	}
	elseif( !empty( $header_custom_color_global ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '.main-header .ld-module-trigger, .main-header .ld-search-form .input-icon' ) ]['color'] = $header_custom_color_global;
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '.main-header .nav-trigger .bar' ) ]['background-color'] = $header_custom_color_global;
	}
	...
	if( !empty( $nav_custom_bg ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=classic] .navbar-collapse, [data-mobile-nav-style=minimal] .navbar-collapse' ) ]['background'] = $nav_custom_bg;
	}
	elseif( !empty( $nav_custom_bg_global ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=classic] .navbar-collapse, [data-mobile-nav-style=minimal] .navbar-collapse' ) ]['background'] = $nav_custom_bg_global;
	}
	
	if( !empty( $nav_modern_bg ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=modern]:before' ) ]['background'] = $nav_modern_bg . '!important';
	}
	elseif( !empty( $nav_modern_bg_global ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=modern]:before' ) ]['background'] = $nav_modern_bg_global . '!important';
	}

	if( !empty( $nav_custom_color ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=classic] .navbar-collapse, [data-mobile-nav-style=minimal] .navbar-collapse' ) ]['color'] = $nav_custom_color;
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( 'ul.nav.main-nav > li > a, ul.nav.main-nav > li > a:hover, .main-nav .children > li.active > a, .main-nav .children > li.current-menu-item > a, .main-nav .children > li:hover > a, .nav-item-children > li.active > a, .nav-item-children > li.current-menu-item > a, .nav-item-children > li:hover > a' ) ]['color'] = 'inherit !important';
	}
	elseif( !empty( $nav_custom_color_global ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=classic] .navbar-collapse, [data-mobile-nav-style=minimal] .navbar-collapse' ) ]['color'] = $nav_custom_color_global;
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( 'ul.nav.main-nav > li > a, ul.nav.main-nav > li > a:hover, .main-nav .children > li.active > a, .main-nav .children > li.current-menu-item > a, .main-nav .children > li:hover > a, .nav-item-children > li.active > a, .nav-item-children > li.current-menu-item > a, .nav-item-children > li:hover > a' ) ]['color'] = 'inherit !important';
	}
	
	if( !empty( $nav_modern_color ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=modern] .navbar-collapse-clone ul .nav-item-children > li > a, [data-mobile-nav-style=modern] .navbar-collapse-clone ul > li > a, [data-mobile-nav-style=modern] .navbar-collapse-clone ul.nav.main-nav .nav-item-children > li > a, [data-mobile-nav-style=modern] .navbar-collapse-clone ul.nav.main-nav > li > a' ) ]['color'] = $nav_modern_color;
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=modern] .navbar-collapse-clone ul .nav-item-children > li > a:hover, [data-mobile-nav-style=modern] .navbar-collapse-clone ul > li > a:hover, [data-mobile-nav-style=modern] .navbar-collapse-clone ul.nav.main-nav .nav-item-children > li > a:hover, [data-mobile-nav-style=modern] .navbar-collapse-clone ul.nav.main-nav > li > a:hover' ) ]['color'] = 'inherit !important';
	}
	elseif( !empty( $nav_modern_color_global ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=modern] .navbar-collapse-clone ul .nav-item-children > li > a, [data-mobile-nav-style=modern] .navbar-collapse-clone ul > li > a, [data-mobile-nav-style=modern] .navbar-collapse-clone ul.nav.main-nav .nav-item-children > li > a, [data-mobile-nav-style=modern] .navbar-collapse-clone ul.nav.main-nav > li > a' ) ]['color'] = $nav_modern_color_global;
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( '[data-mobile-nav-style=modern] .navbar-collapse-clone ul .nav-item-children > li > a:hover, [data-mobile-nav-style=modern] .navbar-collapse-clone ul > li > a:hover, [data-mobile-nav-style=modern] .navbar-collapse-clone ul.nav.main-nav .nav-item-children > li > a:hover, [data-mobile-nav-style=modern] .navbar-collapse-clone ul.nav.main-nav > li > a:hover' ) ]['color'] = 'inherit !important';
	}
	
	if( !empty( $nav_border_color ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( 'ul.nav.main-nav > li > a' ) ]['border-color'] = $nav_border_color;
	}
	elseif( !empty( $nav_border_color_global ) ) {
		$css['@media screen and (max-width: 1199px)'][ liquid_implode( 'ul.nav.main-nav > li > a' ) ]['border-color'] = $nav_border_color_global;
	}	
